# NOTE : IMAGES (SCREENSHOTS) MAY CONTAIN ALTERED DATA OR ANY DATA AT ALL THIS IS DUE TO NO ACCESS TO ATTENDANCE,WORKSHOPS,FACULTY DATA AND OTHER COLLEGE DATA.ALL THE FEATURES MENTIONED HERE ARE PEFECTLY WORKING WITH SAMPLE DATA CREATED BY MY TEAM.
