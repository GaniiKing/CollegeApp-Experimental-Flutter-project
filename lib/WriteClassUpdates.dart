...
class WriteClassUpdates extends StatefulWidget {
  const WriteClassUpdates({super.key});

  @override
  State<WriteClassUpdates> createState() => _WriteClassUpdatesState();
}

class _WriteClassUpdatesState extends State<WriteClassUpdates> {
  ...
  Future<void> fetchOptions(branchfromdb) async {
    print(branchfromdb);
    var url = "http://your_ip_address/sample_api/fetchclassoptionsfromdb.php";
    var response = await http.post(Uri.parse(url),body: {
