...
class MyYearUpdates extends StatefulWidget {
  const MyYearUpdates({super.key});

  @override
  State<MyYearUpdates> createState() => _MyYearUpdatesState();
}

class _MyYearUpdatesState extends State<MyYearUpdates> {
  ...
  Future<void> fetchUpdates() async {
    ...
    print('fetching users...from year updates');
    var url="http://your_ip_address/sample_api/myyearupdates.php";
    ...
    return  Container(
      ...
      child: Scaffold(
        appBar: AppBar(
          ...
          title: Text('My Year Updates',style: TextStyle(fontSize: 20),),
        ),
