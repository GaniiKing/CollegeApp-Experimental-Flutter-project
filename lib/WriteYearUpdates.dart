...
class WriteYearUpdates extends StatefulWidget {
  const WriteYearUpdates({super.key});

  @override
  State<WriteYearUpdates> createState() => _WriteYearUpdatesState();
}

class _WriteYearUpdatesState extends State<WriteYearUpdates> {
  ...
  Future<void> fetchOptions(branchfromdb) async {
    print(branchfromdb);
    var url = "http://your_ip_address/sample_api/fetchyearoptionsfromdb.php";
    var response = await http.post(Uri.parse(url),body: {
