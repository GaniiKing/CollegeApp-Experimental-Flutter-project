...
class DeptUpdates extends StatefulWidget {
  const DeptUpdates({super.key});

  @override
  State<DeptUpdates> createState() => _DeptUpdatesState();
}

class _DeptUpdatesState extends State<DeptUpdates> {
  List Updates =[];
  String number="";
  ...
  Future<void> fetchUpdates() async {
    ...
    print('fetching users...from dept updates');
    var url="http://your_ip_address/sample_api/mydeptupdates.php";
    ...
    return  Container(
      ...
      child: Scaffold(
        appBar: AppBar(
          ...
          title: Text('My Department Updates',style: TextStyle(fontSize: 20),),
        ),
